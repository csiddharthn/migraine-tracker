...
apply_ui()
page_header(
    tr("Mögliche Auslöser", "Possible triggers"),
    tr("Welche Auslöser ausgewählt oder in den Notizen erwähnt wurden.", "Which possible triggers were selected or mentioned in the notes."),
)
