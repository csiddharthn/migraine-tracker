...
CODE_LABELS = {
    ...
    "excel_migration": ("Excel-Import", "Excel import"),
...
TRIGGER_DESCRIPTIONS_EN = {
    ...
    "ND": "Only for migrated Excel entries without a documented trigger.",
}
...
VALUE_TRANSLATIONS = {
    ...
    "Aus Excel übernommene Tage ohne Kopfschmerzen": "Headache-free days imported from Excel",
    "Aus Excel übernommene Kopfschmerzeinträge": "Headache entries imported from Excel",
    "Beim erneuten Excel-Import aktualisiert": "Updated during a repeated Excel import",
    "Bereits unverändert aus Excel übernommen": "Already imported unchanged from Excel",
    "Doppelte Excel-Zeilen": "Duplicate Excel rows",
    "Nicht übernommene Excel-Zeilen": "Excel rows not imported",
    "Duplikat": "Duplicate",
    "Abgelehnt": "Rejected",
    ...
    "Nur für migrierte Excel-Einträge ohne ausgefüllten Auslöser.": "Only for migrated Excel entries without a documented trigger.",
    ...
    "Übernahme aus Excel": "Import from Excel",
    ...
    "Beim Excel-Einmalimport archivierte Quellzeilen.": "Source rows archived during the one-time Excel import.",
    ...
    "Informationen zur einmaligen Übernahme der ursprünglichen Excel-Zeilen.": "Information about the one-time import of the original Excel rows.",
