...
class MigraineEntry(TimestampMixin, Base):
    ...
    timeline_notes: Mapped[str] = mapped_column(Text, default="", nullable=False)
    possible_factors: Mapped[str] = mapped_column(Text, default="", nullable=False)
    symptoms_and_actions: Mapped[str] = mapped_column(Text, default="", nullable=False)
    other_notes: Mapped[str] = mapped_column(Text, default="", nullable=False)
